        ...
        <form @submit.prevent="onSubmit">
            ...
            <div class="relative z-0 w-full mb-6 group">
                ...
                <select v-model="form.brand_id" id="brand_id" name="brand_id" autocomplete="brand_id"
                    ...
                    <option :selected="selected" v-for="brand in brands" :value="brand.id">{{ brand.name }}</option>
                </select>
                <ErrorMessage :error="form.errors.brand_id"/>
            </div>
            <div class="relative z-0 w-full mb-6 group">
                <div class="relative w-24 h-24">
                    <img class="rounded-full border border-gray-100 shadow-sm" :src="carModel.image.path" alt="image" />
                </div>
...
const form = useForm({
    ...
    brand_id: props.carModel.brand_id,
    description: props.carModel.description,
    image : '',
});
...
const onSubmit = () => {
    form.post('/car-models/' + props.carModel.id);
};
</script>
