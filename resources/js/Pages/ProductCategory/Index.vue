<template>
    ...
    <div class="flex justify-between mb-4">
        <div class="flex items-center">
            <h1 class="text-3xl">Product Categories</h1>
            <Link href="/product-categories/create" class="bg-blue-400 text-white rounded text-sm ml-4 py-2 px-4 hover:bg-blue-500">Create</Link>
        </div>
        <div class="relative">
   ...
   <Table :items="productCategories.data" :columns="columns" :links="productCategories.meta.links" :url="$page.url.split('?')[0]"/>
</template>
